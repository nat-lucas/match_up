      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Obx(() {
            ...
            final liveData = liveScoreController.liveScores;
            ...
            liveScoreController.status.value =
                liveData.first.strStatus?.isNotEmpty == true
                    ? liveData.first.strStatus!
                    : (liveData.first.strProgress ?? "");
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      TeamScoor(
                        image: liveData.first.strHomeTeamBadge ?? "",
                        title: liveData.first.strHomeTeam,
                      ),
                      Column(
                        children: [
                          ...
                          CustomTextPopins(
                            text:
                                "${liveData.first.intHomeScore ?? "-"}-${liveData.first.intAwayScore ?? "-"}",
                            fontWeight: FontWeight.w700,
                            size: 27.sp,
                            color: AppColor.primaryColor,
                          ),
                      ...
                      TeamScoor(
                        image: liveData.first.strAwayTeamBadge ?? "",
                        title: liveData.first.strAwayTeam,
                      ),
                    ],
                  ),
